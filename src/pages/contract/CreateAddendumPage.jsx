...
import { listContracts, getContractById } from "../../services/api/contracts"; // Đã bỏ requestTermination
...
const CreateAddendumPage = () => {
    ...
    const [loadingContracts, setLoadingContracts] = useState(false); // eslint-disable-line no-unused-vars
    ...
    // 3. Tự động set Ngày hết hiệu lực
    useEffect(() => {
                        ...
                        <Card className="shadow-sm mb-4 border-0">
                            ...
                            <Card.Body>
                                <Row className="g-3">
                                    ...
                                    <Col md={12}>
                                        <Form.Group>
                                            <Form.Label>Loại phụ lục <span className="text-danger">*</span></Form.Label>
                                                ...
                                                {ADDENDUM_TYPES.map(type => (
                                                    <div
                                                        ...
                                                        className={`
                                                            ...
                                                            ${addendumType === type.value ? 'ring-2 bg-primary-subtle border-primary' : 'hover-bg-light'}
                                                        `}
                                                        style={{ borderWidth: addendumType === type.value ? '2px' : '1px' }}
                                                    >
                                                        <div className="fw-bold d-flex align-items-center gap-2 text-dark">
                                                            <div className={`rounded-circle p-1 ${addendumType === type.value ? 'bg-primary' : 'bg-secondary'}`} style={{width: 10, height: 10}}></div>
                                                            {type.label}
                                                        </div>
